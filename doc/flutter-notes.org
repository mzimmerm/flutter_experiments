...
* Flutter Environment Full Installation - see  https://flutter.dev/docs/get-started/install/linux but I am making simplifications - NO Android Studio, ONLY Android sdk-tools
